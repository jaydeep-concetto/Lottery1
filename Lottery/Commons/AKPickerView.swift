...
@objc public protocol AKPickerViewDelegate: UIScrollViewDelegate {
    @objc optional func pickerView(_ pickerView: AKPickerView, tap item: Int)
...
private class AKCollectionViewCell: UICollectionViewCell {
	...
	var _selected: Bool = false {
		didSet(selected) {
            ...
            self.label.backgroundColor = self.isSelected ? UIColor.init(hex: "006633") : UIColor.init(hex: "bbbbbb")
            self.label.layer.cornerRadius = self.isSelected ? 15 : 12.5
		}
	}
...
public class AKPickerView: UIView, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, AKCollectionViewLayoutDelegate {
	...
	*/
    fileprivate func sizeForString(_ string: NSString, b:Bool) -> CGSize {
	...
	*/
	...
	public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
		...
		if let title = self.dataSource?.pickerView?(self, titleForItem: indexPath.item) {
            ...
            cell.label.bounds = CGRect(origin: CGPoint.zero, size: self.sizeForString(title as NSString, b: cell.isSelected))
	...
	public func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
		...
		if let title = self.dataSource?.pickerView?(self, titleForItem: indexPath.item) {
                ...
                size.width += self.sizeForString(title as NSString, b: (indexPath.item == self.selectedItem)).width
	...
	public func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        self.delegate?.pickerView?(self, tap: indexPath.item)
	}
